...
predict_stglmm <- function(location_index, Stratum_index, time_index) {
  as.vector(bird_stglmm$samples[5001:10000,,"beta_0"] +
...
bird_stglmm_ppc <- ppc_dens_overlay(model_data$SpeciesTotal, exp(posterior_predictions[(nrow(posterior_predictions)/2):nrow(posterior_predictions),])) +
  lims(x = c(0, 150)) +
  theme_minimal()

bird_stglmm_ppc

ggsave("figures/3-19_bird-stglmm-ppc.png", bird_stglmm_ppc, width = 8, height = 6)
```
