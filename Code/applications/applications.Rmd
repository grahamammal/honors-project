...
vline_data = tibble(xintercept = c(1,1,1,-1, 1, 1,0.2, 0.2),
                    variable_tex = unique(sim_phi_0_2_draws$variable_tex))
sim_phi_0_2_draws %>% 
...
```{r}
plot_quantiles <- function(n, truth) {
  sim_phi_0_2_draws %>% 
    ...
    annotate("text", label = TeX(glue("True $\\beta_{n}$")), x = 110, y = truth) +
